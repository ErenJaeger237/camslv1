...
from .routes import auth, chat, practice, autocomplete, contributions, retrain, retrain_signs, clips, signs, password_reset
...
app.include_router(retrain_signs.router, prefix="/api")
